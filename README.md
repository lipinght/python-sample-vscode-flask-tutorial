...
[![Build Status](https://dev.azure.com/liphuan/Tutorial/_apis/build/status/lipinght.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/liphuan/Tutorial/_build/latest?definitionId=1&branchName=master)
